		...
		>
			<div style="--as:center; --mr:0.5rem">
				<svg
					...
					style="--w:1rem; --h:1rem"
				>
					<path d="M.5 17h23v2.5H.5z" />
					<path d="M5.5 3h3v14h-3zM15.5 3h3v14h-3z" />
					<path d="M4.75 3h4.5v1.5h-4.5zM14.75 3h4.5v1.5h-4.5z" />
					<path d="M1 12Q3.5 4.5 7 4.5L7 6.5Q4 6.5 1.5 13.5z" />
					<path d="M7 4.5Q12 16 17 4.5L17 6.5Q12 17.5 7 6.5z" />
					<path d="M17 4.5Q20.5 4.5 23 12L22.5 13.5Q20 6.5 17 6.5z" />
				</svg>
			</div>
